...
const RootLayout = ({
  ...
  children: React.ReactNode;
    ...
    <html lang="en" suppressHydrationWarning>
      <body
      className={`${geistSans.variable} ${geistMono.variable} bg-black font-sans text-sm text-neutral-50 antialiased max-w-5xl mx-auto border scroll-smooth border-x-neutral-800 border-y-0 overflow-x-hidden min-h-svh`}>
      <Header />
      <TopBar />
      <main>
        {children}

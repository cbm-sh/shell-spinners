...
export const CopyKeyframesButton: React.FC<CopyKeyframesButtonProps> = ({ keyframes }) => {
  ...
  return (
     <button onClick={onCopy} className="absolute top-3 right-14 inline-flex cursor-pointer items-center justify-center p-2 overflow-hidden font-medium text-neutral-50 transition duration-300 ease-out border border-neutral-800 group">
     ...
     {hasCheckIcon ? (
        ...
        <LayersIcon className='size-4 text-neutral-50' />
      )}      </span>

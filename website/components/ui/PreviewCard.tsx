...
export const PreviewCard: React.FC<CardProps> = memo(
	({ children, keyframes, slug, id, ...props }) => {
		return (
			<div
				className='relative flex size-full items-center justify-center border border-neutral-800 bg-black px-8 py-32'
				{...props}
			>
				...
				<div className='absolute top-4 left-4 text-sm text-neutral-50'>{id}</div>
